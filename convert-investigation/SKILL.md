...
- `title` — refined. Investigations often have exploratory titles ("looking into…"); informative trails should read as a statement of what's true ("Titlebar selection opens project-info tab via repository-selected event"). Keep it to **~140 characters or fewer**, and offer the user **2–4 title options** via `AskUserQuestion` to choose from rather than committing one yourself.
